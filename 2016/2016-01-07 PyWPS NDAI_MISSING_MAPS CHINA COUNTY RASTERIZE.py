...
for date in array_all_date_string[start:end]:
    ...
    vector_path = r'D:\Data\ChinaShapefile\Chinese_version_counties//counties_china1.shp'
    ...
    out_filename = r'D:\Downloads\Mattijn@Zhou\ChinaDroughtCounty\shp//china_NDAI'+date_str+'.shp'
