...
df_allyears_raw = pd.read_csv(r'D:\data_dataframes_csv//df_allyears_raw.csv', 
                                index_col=0, parse_dates=True)
df_allyears_class = pd.read_csv(r'D:\data_dataframes_csv//df_allyears_class.csv', 
                                index_col=0, parse_dates=True)
...
for month, data_month in df_allyears_class_grouped:
    print str(month).zfill(2),
...
plt.tight_layout()  
plt.savefig(r'D:\Downloads\Mattijn@Jia\png\trial_6//pca_allmonths_5.png', dpi=300)
plt.show()
