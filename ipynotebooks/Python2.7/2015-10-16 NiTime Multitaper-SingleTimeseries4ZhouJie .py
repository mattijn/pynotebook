...
# The single loop part for a single timeseries. It extract all timeseries in a block of 200 by 200
...
# As TRMM is lower resolution than NDVI, lot of equal timeseries, only extract the unique ones in the block of 200 by 200, and plot
...
# compute the mean for all the unique timeseries in this block of 200 by 200
