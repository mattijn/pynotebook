...
class Process(WPSProcess):
    ...
    def __init__(self):
        ...
        #self.hist_ts1 = self.ComplexOutput(identifier  = "hist_ts1", 
    ...
    def execute(self):
        ...
        # Save to out        
        try:
            #label_ts1 = str(date_list_string[0])
            label_ts1 = "hello"
            hist_ts1 = StringIO()
            ...
            logging.info(hist_ts1.getvalue())
        except :
        ...
        #try:
            ...
            #logging.info(hist_ts2.getvalue())
        ...
        #    logging.info(hist_ts3.getvalue())
        ...
        #    logging.info(hist_ts4.getvalue())
        ...
        #    logging.info(hist_ts5.getvalue())
