...
class Process(WPSProcess):
    ...
    def execute(self):
        ...
        ndvi,dates,str_date,end_date,time=REQUEST_DATA_XML(lon_center,lat_center,pix_offset,coverageID='modis_13c1_cov')
        ...
        lst,dates,str_date,end_date,time=REQUEST_DATA_XML(lon_center,lat_center,pix_offset,coverageID='modis_11c2_cov')
