...
def COMPUTE_NVAI(lon_center=5.6943, lat_center=53.1533, pix_offset=0, 
    ...
    full_url = "http://159.226.117.95:8080/rasdaman/ows/wcs2?service=WCS&version=2.0.1&request=GetCoverage&coverageId=NDVI_MOD13C1005&subset=Long("+Long1+","+Long2+")&subset=Lat("+Lat1+","+Lat2+")"
