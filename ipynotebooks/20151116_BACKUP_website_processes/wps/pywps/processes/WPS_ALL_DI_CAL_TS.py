...
class Process(WPSProcess):
    ...
    def execute(self):
        ...
        ndvi,dates,str_date,end_date,time=REQUEST_DATA_XML(lon_center,lat_center,pix_offset,coverageID='NDVI_MOD13C1005')
        ...
        lst,dates,str_date,end_date,time=REQUEST_DATA_XML(lon_center,lat_center,pix_offset,coverageID='LST_MOD11C2005')
        tci_json = COMPUTE_TCI(lst,dates,str_date,end_date,time,pyhants,ann_freq,outliers_rj,from_date,to_date)
        ntai_json = COMPUTE_NTAI(lst,dates,str_date,end_date,time,pyhants,ann_freq,outliers_rj,from_date,to_date)
