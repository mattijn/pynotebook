...
gdf_df_stats.columns[5] # P00082014


# In[ ]:

# get column names
ax1_head = gdf_df_stats.columns[7] # P00082014
ax2_head = gdf_df_stats.columns[8] # P10082014
ax3_head = gdf_df_stats.columns[9] # P20082014
ax4_head = gdf_df_stats.columns[10] # P30082014
ax5_head = gdf_df_stats.columns[6]  # MEAN
ax6_head = gdf_df_stats.columns[5]  # DC0082014
print ax1_head, ax2_head, ax3_head, ax4_head, ax5_head, ax6_head
columns_shp = [ax1_head, ax2_head, ax3_head, ax4_head, ax5_head, ax6_head]
# drop NaN values for axis
gdf_df_stats.dropna(inplace=True, subset=columns_shp)
